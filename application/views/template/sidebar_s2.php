			...
			<ul class="nav nav-success">
				...
				<li <?php if ($this->uri->segment(3) == 'kelas_s' || $this->uri->segment(3) == 'kelas_ps') {
						...
						<div class="dropdown-menu">
							<a href="<?= base_url('pengajar/pengajar/kelas_s'); ?>" class="nav-item"><i class="fa fa-male"></i>Data Kelas ISMAH</a>
							<a href="<?= base_url('pengajar/pengajar/kelas_ps'); ?>" class="nav-item"><i class="fa fa-female"></i>Data Kelas ISWAH</a>

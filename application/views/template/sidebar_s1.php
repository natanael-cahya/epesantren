            ...
            <ul class="nav nav-success">
                ...
                <li <?php if ($this->uri->segment(3) == 'extra_s' || $this->uri->segment(3) == 'extra_s2') {
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= base_url('pengasuhan/pengasuhan/extra_s'); ?>" class="nav-item"><i
                                class="fa fa-male"></i>Data Santri/wati - Extra</a>
                        <a href="<?= base_url('pengasuhan/pengasuhan/extra_s2'); ?>" class="nav-item"><i
                ...
                <li <?php if ($this->uri->segment(3) == array('pp', 'pi', 'pm', 'pb', 'or', 'km', 'kb')) {
                    ...
                    <div class="dropdown-menu bg-dark text-white">
                        ...
                        <a href="<?= base_url('pengasuhan/pengasuhan/pm'); ?>">
                            <i class="fas fa-gavel"></i>
                            <p>Pelanggaran KMI</p>

                        </a>
                        <a href="<?= base_url('pengasuhan/pengasuhan/pb'); ?>">
                            <i class="fas fa-gavel"></i>
                            <p>Pelanggaran Bahasa</p>

                        </a>
                        <a href="<?= base_url('pengasuhan/pengasuhan/pi'); ?>">
                            <i class="fas fa-gavel"></i>
                            <p>Pelanggaran Peribadatan</p>

                        </a>
                        <a href="<?= base_url('pengasuhan/pengasuhan/or'); ?>">
                            <i class="fas fa-gavel"></i>
                            <p>Pelanggaran Olahraga</p>

                        </a>
                        <a href="<?= base_url('pengasuhan/pengasuhan/km'); ?>">
                            <i class="fas fa-gavel"></i>
                            <p>Pelanggaran Keamanan</p>

                        </a>
                        <a href="<?= base_url('pengasuhan/pengasuhan/kb'); ?>">
                            <i class="fas fa-gavel"></i>

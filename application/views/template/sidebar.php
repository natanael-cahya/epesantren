	            ...
	            <ul class="nav nav-success">
	                ...
	                <li <?php if ($this->uri->segment(3) == 'kelas' || $this->uri->segment(3) == 'kelas_p') {
	                    ...
	                    <div class="dropdown-menu">
	                        <a href="<?= base_url('admin/admin/kelas'); ?>" class="nav-item"><i class="fa fa-male"></i>Data
	                            Kelas ISMAH</a>
	                        <a href="<?= base_url('admin/admin/kelas_p'); ?>" class="nav-item"><i
	                ...
	                <li <?php if ($this->uri->segment(3) == 'kamar' || $this->uri->segment(3) == 'kamar_p') {
	                    ...
	                    <div class="dropdown-menu">
	                        <a href="<?= base_url('admin/admin/kamar'); ?>" class="nav-item"><i class="fa fa-male"></i>Data
	                            Kamar ISMAH</a>
	                        <a href="<?= base_url('admin/admin/kamar_p'); ?>" class="nav-item"><i
	                                class="fa fa-female"></i>Data Kamar ISWAH</a>
	                ...
	                <li <?php if ($this->uri->segment(3) == 'kelas_s' || $this->uri->segment(3) == 'kelas_ps') {
	                    ...
	                    <div class="dropdown-menu">
	                        <a href="<?= base_url('admin/admin/kelas_s'); ?>" class="nav-item"><i
	                                class="fa fa-male"></i>Data Kelas ISMAH</a>
	                        <a href="<?= base_url('admin/admin/kelas_ps'); ?>" class="nav-item"><i
	                                class="fa fa-female"></i>Data Kelas ISWAH</a>
	                ...
	                <li <?php if ($this->uri->segment(3) == 'kamar_s' || $this->uri->segment(3) == 'kamar_ps') {
	                    ...
	                    <div class="dropdown-menu">
	                        <a href="<?= base_url('admin/admin/kamar_s'); ?>" class="nav-item"><i
	                                class="fa fa-male"></i>Data Kamar ISMAH</a>
	                        <a href="<?= base_url('admin/admin/kamar_ps'); ?>" class="nav-item"><i
	                                class="fa fa-female"></i>Data Kamar ISWAH</a>
	                ...
	                <li <?php if ($this->uri->segment(3) == 'extra_s' || $this->uri->segment(3) == 'extra_s2') {
	                    ...
	                    <div class="dropdown-menu">
	                        <a href="<?= base_url('admin/admin/extra_s'); ?>" class="nav-item"><i
	                                class="fa fa-male"></i>Data Santri/wati - Extra</a>
	                        <a href="<?= base_url('admin/admin/extra_s2'); ?>" class="nav-item"><i
	                                class="fa fa-female"></i>Santri/wati Tanpa Extra</a>
	                ...
	                <li <?php if ($this->uri->segment(3) == array('pp', 'pi', 'pm', 'pb', 'or', 'km', 'kb')) {
							echo 'class= "nav-item active"';
						} else {
							echo 'class= "nav-item "';
						} ?>>
	...
	<!-- Modal -->
	<div class="modal fade" id="edit_profile" tabindex="-1" role="dialog" aria-labelledby="profileLabel"
	    aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">

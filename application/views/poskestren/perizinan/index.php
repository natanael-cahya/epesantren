        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Form Tambah Perizinan</h5>
                ...
                <div class="modal-body">
                    ...
                    <form name="f1" method="post" action="<?= base_url('poskestren/perizinan/tb_data'); ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="javascript:void(0);" style="cursor: pointer;" NAME="SANTRI"
                                    title="Klik Untuk Cari SANTRI" onClick='javascript:window.open("perizinan/t_santri_konsulat","Ratting",

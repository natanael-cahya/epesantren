<div class="main-panel">
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Data Pelanggaran Olahraga</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Data Pelanggaran Olahraga</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pp as $l) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <a class="btn btn-primary btn-xs text-white ml-1" href="<?= base_url('pengasuhan/pengasuhan/edit_or/');
                                                                                                                    echo $l->code_pelanggaran . '/' . $this->uri->segment(4) ?>"><i class="fa fa-edit"></i></a>
                                                            <a href="<?= base_url('pengasuhan/crud_pelanggaran/h_pel/');
                                                                        echo $l->code_pelanggaran . "/or" ?>" class="btn btn-danger btn-sm text-white ml-1"><i class="fa fa-trash"></i></a>
                                                        </div>
    ...
    <div class="modal fade" id="modalpp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Form Data Pelanggaran Olahraga</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form name="f1" method="post" action="<?= base_url('pengasuhan/crud_pelanggaran/tb_pel'); ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" class="form-control" name="sort" value="olahraga">

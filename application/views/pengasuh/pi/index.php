<div class="main-panel">
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Data Pelanggaran Peribadatan</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Data Pelanggaran Peribadatan</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a target="_blank" href="<?= base_url('admin/laporan/l_pel/peribadatan'); ?>"
                                    class="btn btn-warning btn-xs ml-auto">
                                    <i class="fa fa-print"></i>
                                    Print Data
                                </a>&nbsp;
                                <a target="_blank" href="<?= base_url('admin/laporan/export_Apel/peribadatan'); ?>"
                                    class="btn btn-info btn-xs ">
                                    <i class="fa fa-download"></i>
                                    Download Data
                                </a>
    ...
    <div class="modal fade" id="modalpp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Form Data Pelanggaran Peribadatan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="sanksi" class="form-control" placeholder="Input Sanksi"
                                    required>
                                <input type="hidden" class="form-control" name="sort" value="peribadatan">

                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <a href="<?= base_url('admin/laporan/l_kamarS'); ?>/P" target="_blank"
                                    class="btn btn-warning btn-sm ml-auto">
                                    <i class="fa fa-print"></i>
                                    Print Data
                                </a>&nbsp;&nbsp;
                                <a href="<?= base_url('admin/laporan/export_kamar'); ?>/P" target="_blank"
                    ...
                    <form name="f1" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="nama" readonly class="form-control" value="<?= $key->nama ?>"

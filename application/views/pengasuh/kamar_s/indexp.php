<div class="main-panel">
	<div class="content">
		<div class="page-inner">
			...
			<button class="btn btn-info ">Asean</button>
			<button class="btn btn-danger ml-2">Khodijah</button>
			<button class="btn btn-warning ml-2">Aisyah</button>
			</div>

			<!-- Menu kelassssssssss -->
							<div class="d-flex align-items-center">
							<a href="<?= base_url('admin/laporan/l_kamarS'); ?>/P" target="_blank" class="btn btn-warning btn-sm ml-auto">
									<i class="fa fa-print"></i>
									Print Data
								</a>&nbsp;&nbsp;
								<a href="<?= base_url('admin/laporan/export_kamar'); ?>/P" target="_blank" class="btn btn-info btn-sm">
						...
						"width=950,height=570,toolbar=1,status=1,");'>
								...
								<div class="row">
									<div class="col">
										...
										<input type="text" name="nama" readonly class="form-control" value="<?= $key->nama ?>" id="nama" placeholder="Nama">
									</div>
								</div>
								<br>
								<div class="row">

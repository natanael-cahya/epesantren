        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Edit Data Kamar Santri (Iswah)</a>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <a href="#nis" data-toggle="modal" data-target="#nis">
                                                        <input type="text" onchange="ambilnise(this.value)" name="nise" value="<?= $key->nis ?>" class="form-control" id="nisee" placeholder="NIS">
                                                    </a>

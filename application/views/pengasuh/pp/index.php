				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							<br>
							<div class="d-flex align-items-center">
								<a target="_blank" href="<?= base_url('pengasuhan/laporan/l_pel'); ?>" class="btn btn-warning btn-sm ml-auto">
									<i class="fa fa-print"></i>
									Print Data
								</a>&nbsp;
								<a target="_blank" href="<?= base_url('pengasuhan/laporan/export_Apel'); ?>" class="btn btn-info btn-sm">

        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Edit Data Pelanggaran Pengasuhan</a>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                <h3>
                                    Edit Data Pelanggaran Pengasuhan
                                </h3>
                                        ...
                                        <form name="f1" method="post" enctype="multipart/form-data" action="<?= base_url('admin/crud_pelanggaran/ed_pel'); ?>">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input type="text" readonly name="nise" onchange="ambilnise(this.value)" value="<?= $k->nis ?>" class="form-control" id="nisee" placeholder="NIS">

                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a target="_blank" href="<?= base_url('admin/laporan/l_pel/kebersihan'); ?>"
                                    class="btn btn-warning btn-xs ml-auto">
                                    <i class="fa fa-print"></i>
                                    Print Data
                                </a>&nbsp;
                                <a target="_blank" href="<?= base_url('admin/laporan/export_Apel/kebersihan'); ?>"
                                    class="btn btn-info btn-xs ">
                                    <i class="fa fa-download"></i>
                                    Download Data
                                </a>
                    ...
                    <form name="f1" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="" class="form-control" required value="<?= $k->nama ?>"

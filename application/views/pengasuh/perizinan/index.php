<div class="main-panel">
                                                ...
                                                <td style="width:10%;">
                                                    <div class="row">
                                                        <a class="btn btn-primary btn-xs text-white ml-1"
                                                            href="<?= base_url('pengasuhan/perizinan/edit_perizinan/');
    ...
    <div class="modal fade" id="modalsantriz<?= $l->code_perizinan ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Data Izin Santri/Wati</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form name="f1" method="post" enctype="multipart/form-data"
                        action="<?= base_url('pengasuhan/perizinan/edit'); ?>">
                        <div class="row">
                            <div class="col">
    ...
    <div class="modal fade" id="modalpp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Form Data Tambah Perizinan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form name="f1" method="post" action="<?= base_url('pengasuhan/perizinan/tb_data'); ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="javascript:void(0);" style="cursor: pointer;" NAME="SANTRI"
                                    title="Klik Untuk Cari SANTRI" onClick='javascript:window.open("pengasuhan/t_santri_konsulat","Ratting",
						"width=950,height=570,toolbar=1,status=1,");'>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="foto">Sampai Tanggal</label>
                                <input type="datetime-local" name="ts" class="form-control">
                            </div>
                        </div>
                        <br>
                        <div class="row">

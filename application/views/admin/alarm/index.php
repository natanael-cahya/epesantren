...
<script>
	...
	function ala(){
		var jd = window.open('pop','My Window','height= 200 px,width =300 px,');
			setTimeout(function() { jd.close();}, 180000);
	}
</script>
...
<table border="2" width="90%" align="center" class="text-white text-center">
	...
	<tr>
		...
		<a class="btn btn-primary float-left btn-sm" data-toggle="modal" data-target="#modaltb">Tambah Alarm</a>
	...
	<tr>
		...
		<td class="p-2">Jam</td><td>:</td><td><?= $keys->jam ?> : <?= $keys->menit ?></td><td><a class="btn btn-warning btn-sm" href="<?= base_url('admin/crud_alarm/h_alarm/'); echo $keys->code_ja ?>">Hapus </button></td>
	</tr>
	<?php }  ?>
</table>
</div>
...
<table border="0" align="center" style="margin-top: 170px;" >
	...
	<tr style="text-align: center;">
		<td><div id="jam" class="bg-white text-center col-12 p-4 h1 font-weight-bold rounded"></div></td><td  style="font-weight: bold;font-size: 20pt;" class="text-white">:</td>
		<td><div id="menit" class="bg-white text-center col-12 p-4 h1 font-weight-bold  rounded"></div></td><td style="font-weight: bold;font-size: 20pt;" class="text-white">:</td>
		<td><div id="detik" class="bg-white text-center col-12 p-4 h1 font-weight-bold  rounded"></div></td>
	</tr>
	<tr>
		<td colspan="5">
			&nbsp;
	...
	<tr>
		<br><br><td colspan="5" class="text-white h5" style="text-align: center;font-weight: bolder;">ALARM SELANJUTNYA<br><br></td>
	</tr>
			...
			<div class="modal-content">
				...
				<div class="table-responsive">
									<table id="basic-datatables" class="display table table-striped table-hover">
										<thead>
										<tr>
										<th colspan="4" class="text-center bg-info text-white"><h4>Data Semua Alarm</h4></th>
										</tr>
											<tr>
												<th>No</th>
												<th>Tanggal</th>
										...
										foreach($all as $key){ ?>
												<tr>
													...
													<td><a class="btn btn-danger btn-sm" href="<?= base_url('admin/crud_alarm/h_alarm/'); echo $key->code_ja ?>">X</a></td>
												</tr>
											<?php }  ?>
										</tbody>
									</table>

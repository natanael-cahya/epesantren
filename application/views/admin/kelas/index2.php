<div class="main-panel">
                                                ...
                                                <td style="width:10%;">
                                                    <div class="row">
                                                        ...
                                                        <a class="btn btn-primary btn-xs text-white" data-toggle="modal"
                                                            data-target="#modaled<?= $key->code_kelas ?>"><i
                    ...
                    <form name="f1z" method="post" action="<?= base_url('admin/crud_kelas/tb_kelas'); ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR"
                                    onClick='javascript:window.open("twalikelaswanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
                            ...
                            <div class="col">
                                ...
                                <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR"
                                    onClick='javascript:window.open("tasistenwanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
    ...
    <!-- Modal edit -->
    <div class="modal fade" id="modaled<?= $key->code_kelas ?>" tabindex="-1" role="dialog"
                    ...
                    <form name="f1z" method="post" action="<?= base_url('admin/crud_kelas/ed_kelas'); ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="foto">Wali Kelas</label>
                                <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR"
                                    onClick='javascript:window.open("ewalikelaswanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
                                    <input type="text" class="form-control" value="<?= $key->wali_kelas ?>" name="wke"
                                        id="wke" placeholder="Nama Wali kelas" required>
                                </a>
                            </div>
                            <div class="col">
                                <label for="foto">Asisten</label>
                                <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR"
                                    onClick='javascript:window.open("easistenwanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
                                    <input type="text" class="form-control" value="<?= $key->asisten ?>" name="ase"
                                        id="ase" placeholder="Nama Asisten" required>
                                </a>

                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Data Kelas Uswah</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:10%;">
                                                        <div class="row">
                                                            ...
                                                            <a class="btn btn-primary btn-xs text-white ml-1" href="<?= base_url('admin/admin/edit_kelas_iswah/');
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Form Data Kelas Uswah</h5>
                    ...
                    <form name="f1z" method="post" action="<?= base_url('admin/crud_kelas/tb_kelas'); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="lembaga" id="lembaga2" class="lembaga2 form-control" required>
                            ...
                            <div class="col">
                                ...
                                <select name="marhalah" id="marhalah" class="marhalah2 form-control" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rk" class="form-control" required>
                                    <option>AT-Taubah</option>
                                    <option>AL-Ikhlas</option>
                                    <option>AR-Rahman</option>
                                    <option>AL-Kautsar Selatan atas</option>
                                    <option>AL-Kautsar Selatan bawah</option>
                                    <option>AN-Nur</option>
                                    <option>Perdana</option>
                                    <option>AN-Nisa'</option>
                                    <option>AL-Kautsar Utara atas</option>
                                    <option>ÀL-Kautsar Utara bawah Khodijah</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR" onClick='javascript:window.open("twalikelaswanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
                            ...
                            <div class="col">
                                ...
                                <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR" onClick='javascript:window.open("tasistenwanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
                                    <input type="text" class="form-control" name="as" id="as" placeholder="Nama Asisten" required>
                                </a>
                                <input type="hidden" name="g" value="P">
                    ...
                    <div class="modal-body">
                        ...
                        <form name="f1z" method="post" action="<?= base_url('admin/crud_kelas/ed_kelas'); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select name="lembagae" id="lembaga" class=" lembaga form-control" required>
                                        <option value="<?= $key->id_lembaga ?>">-Jangan diubah bila tak ingin dirubah-
                                        </option>
                                        <?php foreach ($lembaga as $row) : ?>
                                ...
                                <div class="col">
                                    ...
                                    <select name="marhalahe" id="marhalah" class="marhalah form-control" required>
                                        <option value="<?= $key->marhalah ?>">-Jangan diubah bila tak ingin dirubah-
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select name="rke" class="form-control" required>
                                        <option value="<?= $key->nama_kelas ?>">-Jangan diubah bila tak ingin dirubah-
                                        </option>
                                        ...
                                        <option value="ÀL-Kautsar Utara bawah Khodijah">ÀL-Kautsar Utara bawah Khodijah
                                        </option>
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="foto">Wali Kelas</label>
                                    <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR" onClick='javascript:window.open("ewalikelaswanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>
                                ...
                                <div class="col">
                                    <label for="foto">Asisten</label>
                                    <a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR" onClick='javascript:window.open("easistenwanita","Ratting",
						"width=750,height=570,toolbar=1,status=1,");'>

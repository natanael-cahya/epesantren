												...
												<tr>
													...
													<td>
														<div class="row">
															...
															<a class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#modaled<?= $key->code_kelas ?>"><i class="fa fa-edit"></i> </a>
															<a class="btn btn-danger btn-sm text-white ml-1" href="<?= base_url('admin/crud_kelas/h_kelas/');

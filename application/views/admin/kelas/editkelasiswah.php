        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Edit Data Kelas (Iswah)</a>
                            ...
                            <div class="card-body">
                                <div class="container">
                                    ...
                                    <form name="f1z" method="post"
                                        action="<?= base_url('admin/crud_kelas/ed_kelas'); ?>">

                                        <div class="row">

                                            <div class="col">
                                                <label for="foto">Lembaga</label>
                                                <select name="lembagae" id="lembaga" class=" lembaga form-control"
                                                    required>

                                                    <?php foreach ($lembaga as $row) : ?>
                                                    <option <?= $key->lembaga == $row->lembagaa ? 'selected' : '' ?>
                                                        value="<?= $row->id_lembaga; ?>">
                                                        <?= $row->lembagaa; ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="col">
                                                ...
                                                <select name="marhalahe" id="marhalah" class="marhalah form-control"
                                                    required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <select name="rke" class="form-control" required>
                                                    ...
                                                    <option <?= $key->nama_kelas == 'AT-Taubah' ? 'selected' : '' ?>
                                                        value="AT-Taubah">
                                                        AT-Taubah</option>
                                                    <option <?= $key->nama_kelas == 'AL-Ikhlas' ? 'selected' : '' ?>
                                                        value="AL-Ikhlas">AL-Ikhlas</option>
                                                    <option <?= $key->nama_kelas == 'AR-Rahman' ? 'selected' : '' ?> val
                                                        <?= $key->nama_kelas == 'AT-Taubah' ? 'selected' : '' ?>ue="AR-Rahman">
                                                        AR-Rahman</option>
                                                    <option
                                                        <?= $key->nama_kelas == 'AL-Kautsar Selatan atas' ? 'selected' : '' ?>
                                                        value="AL-Kautsar Selatan atas">AL-Kautsar Selatan atas
                                                    </option>
                                                    <option
                                                        <?= $key->nama_kelas == 'AL-Kautsar Selatan bawah' ? 'selected' : '' ?>
                                                        value="AL-Kautsar Selatan bawah">AL-Kautsar Selatan bawah
                                                    </option>
                                                    <option <?= $key->nama_kelas == 'AN-Nur' ? 'selected' : '' ?>
                                                        value="AN-Nur">AN-Nur</option>
                                                    <option <?= $key->nama_kelas == 'Perdana' ? 'selected' : '' ?>
                                                        value="Perdana">Perdana</option>
                                                    <option <?= $key->nama_kelas == 'AN-Nisa' . "'" ? 'selected' : '' ?>
                                                        value="AN-Nisa`">AN-Nisa'</option>
                                                    <option
                                                        <?= $key->nama_kelas == 'AL-Kautsar Utara atas' ? 'selected' : '' ?>
                                                        value="AL-Kautsar Utara atas">AL-Kautsar Utara atas</option>
                                                    <option
                                                        <?= $key->nama_kelas == 'AL-Kautsar Utara bawah Khodijah' ? 'selected' : '' ?>
                                                        value="ÀL-Kautsar Utara bawah Khodijah">ÀL-Kautsar Utara
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <a href="#walikelas" data-toggle="modal" data-target="#walikelas">
                                                    <input type="text" class="form-control"
                                                        value="<?= $key->wali_kelas ?>" name="wk" id="wk"
                                            ...
                                            <div class="col">
                                                ...
                                                <a href="#asisten" data-toggle="modal" data-target="#asisten">
                                                    <input type="text" class="form-control" value="<?= $key->asisten ?>"
                                                        name="as" id="as" placeholder="Nama Asisten" required>
                                                </a>
...
<div class="modal fade walikelas" tabindex="-1" role="dialog" aria-labelledby="walikelas" aria-hidden="true"
    id="walikelas">
...
function etangkap(s) {
    ...
    document.getElementById('as').value = s;
    $('#asisten').modal('hide');
}
</script>
<div class="main-panel">
	<div class="content">
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="basic-datatables" class="display table table-striped table-hover">
										...
										<tbody>
										<?php $p=1; foreach($ortu as $kiy): $hs=$kiy->penghasilan_ayah+$kiy->penghasilan_ibu; ?>
											...
											<tr>
												...
												<td>
													...
													<a class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#modaled<?= $kiy->id_ortu ?>"><i class="fa fa-edit"></i></a>
													<a class="btn btn-danger btn-sm text-white ml-1" href="<?= base_url('admin/crud_ortu/h_ortu/'); echo $kiy->id_ortu ?>"><i class="fa fa-trash"></i> </a>
		...
		<?php $p=1; foreach($ortu as $kiy): ?>
				<!-- Modal edit -->
				<div class="modal fade" id="modaled<?= $kiy->id_ortu ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-success">
						<h5 class="modal-title" id="exampleModalLabel">Form Data Orang Tua</h5>
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col">
								...
								<input type="text" class="form-control" value="<?= $kiy->nis ?>" name="nise" minlength="10" required>
							</div>
							</div>
							<br>
							<div class="row">
								<div class="col">
									<label for="foto">Nama Ayah</label>
									<input type="text" name="ayahe" value="<?= $kiy->nama_ayah ?>" class="form-control" required>
								</div>
								<div class="col">
									<label for="foto">Nama Ibu</label>
									<input type="text" name="ibue" value="<?= $kiy->nama_ibu ?>" class="form-control" required>
							...
							<div class="row">
								<div class="col">
									<label for="foto">Pendidikan Terakhir Ayah</label>
									<input type="text" name="pendidikan_ae" class="form-control" value="<?= $kiy->pend_terakhir_ayah ?>">

								</div>
								<div class="col">
									<label for="foto">Pendidikan Terakhir Ibu</label>
									<input type="text" name="pendidikan_ie" class="form-control" value="<?= $kiy->pend_akhir_ibu ?>">
							...
							<div class="row">
								<div class="col">
									<label for="foto">Pekerjaan Ayah</label>
									<input type="text" name="perkerjaan_ae" class="form-control"  value="<?= $kiy->pekerjaan_ayah ?>">

								</div>
								<div class="col">
									<label for="foto">Pekerjaan Ibu</label>
									<input type="text" name="perkerjaan_ie" class="form-control" value="<?= $kiy->pekerjaan_ibu ?>">
							...
							<div class="row">
								<div class="col">
									<label for="foto">Penghasilan Ayah / Bulan</label>
									<input type="text" name="penghasilan_ae" class="form-control" value="<?= $kiy->penghasilan_ayah ?>">

								</div>
								<div class="col">
									<label for="foto">Penghasilan Ibu / Bulan</label>
									<input type="text" name="penghasilan_ie" class="form-control" value="<?= $kiy->penghasilan_ibu ?>">

                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a target="_blank" href="<?= base_url('admin/laporan/l_pel/peribadatan'); ?>" class="btn btn-warning btn-xs ml-auto">
                                    <i class="fa fa-print"></i>
                                    Print Data
                                </a>&nbsp;
                                <a target="_blank" href="<?= base_url('admin/laporan/export_Apel/peribadatan'); ?>" class="btn btn-info btn-xs ">
                                    <i class="fa fa-download"></i>
                                    Download Data
                                </a>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pp as $l) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <a class="btn btn-primary btn-xs text-white ml-1" href="<?= base_url('admin/admin/edit_pi/');
                                                                                                                    echo $l->code_pelanggaran . '/' . $this->uri->segment(4) ?>"><i class="fa fa-edit"></i></a>


                                                            <a href="<?= base_url('admin/crud_pelanggaran/h_pel/');
                                                                        echo $l->code_pelanggaran . "/pi" ?>" class="btn btn-danger btn-sm text-white ml-1"><i class="fa fa-trash"></i> </a>
                                                        </div>

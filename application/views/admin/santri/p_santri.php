...
<body>
    ...
    <div
        style="background-color: green;width: 25%;border:solid 3px #000; height: 220px;margin-left:auto;margin-right: auto;margin-top: 50px">
        <img src="<?= base_url('upload_img/foto_santri/');
						echo $key->foto ?>" width="100%" height="100%">
    </div>
    <div
        style="background-color: ;width: 100%; height: auto;margin-top:25px; padding-bottom: 10px;padding-top: 10px;font-size: 13pt;">
        <table border="0" align="center" cellspacing="15" width="100%">
            ...
            <tr>
                <td>Kelas (No Gedung)</td>
                <td>:</td>
                <td> <?= $key->kelass . ' (' . $key->no_kls . ')' ?></td>
            </tr>
            <tr>
                <td>Keterangan</td>
                <td>:</td>

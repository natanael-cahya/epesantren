<div class="main-panel">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <br>
                            <div class="d-flex align-items-center">
                                <a target="_blank" href="<?= base_url('admin/laporan/l_dsantri'); ?>"
                                    class="btn btn-warning btn-sm ml-auto" target="_blank">
                                    <i class="fa fa-print"></i>
                                    Print Data
                                </a>&nbsp;|&nbsp;
                                <a target="_blank" href="<?= base_url('admin/laporan/export_santrii'); ?>"
                                ...
                                <div class="table-responsive">
                                    <table id="basic-datatables" class="display table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr
                                                <?= $key->status == 'Alumni' ? "style='background-color:red;color:white;'" : "" ?>>
                                                <td><?= $key->nis ?></td>
                                                <td>
                                                    <a class="image-popup-vertical-fit"
                                                        href="<?= base_url('upload_img/foto_santri/') ?><?= $key->foto ?>">
                                                        <img src="<?= base_url('upload_img/foto_santri/') ?><?= $key->foto ?>"
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-xs text-white" data-toggle="modal"
                                                        data-target="#modaldetail<?= $key->nis ?>"><i
                                                            class="fa fa-eye"></i> </a>
                                                    <a class="btn btn-info btn-xs text-white" data-toggle="modal"
                                                        data-target="#modaldetailz<?= $key->nis ?>"><i
                                                            class="fa fa-pencil-alt"> </i> </a>
                                                    <a href="<?= base_url('admin/crud_dsantri/h_santri/');
                                                                    echo $key->nis . '/' . $key->id_ortu ?>"
    ...
    <?php foreach ($santri as $key) { ?>
    <!-- Modal Detail-->
    <div class="modal fade" id="modaldetail<?= $key->nis ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                        ...
                        <table width="100%" border="0" style="font-size:14px">
                            ...
                            <tr>
                                <td rowspan="17">
                                    <center>
                                        <img src="<?= base_url('upload_img/foto_santri/') ?><?= $key->foto ?>"
                                            style="border-radius: 5px; width: 280px; height: 350px;">
                                    </center>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>TTL</td>
                                <td>:</td>
                                <td><?= $key->tempat_lahir ?> , <?php echo date("d-m-Y", strtotime($key->tgl_lahir)); ?>
                                </td>
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('admin/crud_dsantri/export/');
                                    echo $key->nis ?>" class="btn btn-warning" target="_blank"><i
    ...
    <?php foreach ($santri as $key) { ?>
    <!-- Modal Detail-->
    <div class="modal fade" id="modaldetailz<?= $key->nis ?>" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title" id="exampleModalLabel">Update Status Data Santri</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="table-responsive">
                            <table width="100%" border="0" style="font-size:14px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="status" id="stat" onchange="abi()">
                                            ...
                                            <option <?= $key->status == 'Santri aktif' ? "selected" : "" ?>
                                                value="Santri aktif">Santri Aktif</option>
                                            <option <?= $key->status == 'Abituren' ? "selected" : "" ?>
                                                value="Abituren">Abituren</option>
                                            <option <?= $key->status == 'LULUS' ? "selected" : "" ?> value="LULUS">LULUS
                                            </option>
                                            <option <?= $key->status == 'Pengabdian' ? "selected" : "" ?>
                                                value="Pengabdian">Pengabdian</option>
                                            <option <?= $key->status == 'Alumni' ? "selected" : "" ?> value="Alumni">
                                                Alumni</option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input type="text" name="tmpt" id="respon" class="form-control"
                                            value="<?= $key->tempat_abituren ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form name="f1" method="post" enctype="multipart/form-data"
                        action="<?= base_url('admin/crud_dsantri/up_santri'); ?>">
                        <div class="row">
                            <div class="col">
                                <label for="nis">NIS</label>

                                <input type="text" name="nise" readonly onchange="ambilnise(this.value)"
                                    value="<?= $key->nis ?>" class="form-control" id="nise" placeholder="NIS">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" required name="namae" class="form-control" value="<?= $key->nama ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="jke" class="form-control" required>
                                    <option <?= $key->jk == 'laki-laki' ? "selected" : "" ?> value="laki-laki">Laki -
                                        Laki</option>
                                    <option <?= $key->jk == 'Perempuan' ? "selected" : "" ?> value="Perempuan">Perempuan
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" required name="alamate" value="<?= $key->alamat ?>"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" required name="tempate" value="<?= $key->tempat_lahir ?>"
                                    class="form-control" placeholder="Tempat lahir">
                            </div>
                            <div class="col">
                                <label for="alamat">Tanggal Lahir</label>
                                <input type="text" required name="tgl_lahire" value="<?= $key->tgl_lahir ?>"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="kamare" class="form-control">
                                    ...
                                    <option <?= $ka->code_kamar == $key->code_kamar ? "selected" : "" ?>
                                        value="<?= $ka->code_kamar ?>"><?= $ka->rayon ?> <?= $ka->ruang_kamar ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="kelase" class="form-control">
                                    ...
                                    <option <?= $ka->code_kelas == $key->kelas ? "selected" : "" ?>
                                        value="<?= $ka->code_kelas ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="keterangane" value="<?= $key->keterangan ?>"
    ...
    <!-- Modal Tb data-->
    <div class="modal fade" id="modalsantri" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                ...
                <div class="modal-body">
                    ...
                    <form name="f1" method="post" enctype="multipart/form-data"
                        action="<?= base_url('admin/crud_dsantri/tb_santri'); ?>">
                        <div class="row">
                            <div class="col">
						...
						"width=950,height=570,toolbar=1,status=1,");'>
                                    <input type="text" name="id_ortu" onchange="ambilnis(this.value)"
                                        class="form-control" id="ns" placeholder="Klik Untuk Pilih Orang Tua">
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="alamat">Tanggal Lahir</label>
                                <input type="text" name="tgl_lahir" required autocomplete="off"
                                    class="form-control datepicker" placeholder="Tanggal">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="kamar" class="form-control">
                                    <?php foreach ($kmar as $ka) : ?>
                                    <option value="<?= $ka->code_kamar ?>"><?= $ka->rayon ?> <?= $ka->ruang_kamar ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="col">
                                ...
                                <select name="kelas" class="form-control">
                                    ...
                                    <option value="<?= $ka->code_kelas ?>">
                                        <?= $ka->nama_kelas . ' - ' . $ka->no_kls . ' - ' . $ka->kelass ?><?= $ka->gender == 'L' ? ' (ISMAH)' : ' (ISWAH)' ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="gaji" readonly class="form-control" id="penghasilan_ayah"
                                    placeholder="Gaji">

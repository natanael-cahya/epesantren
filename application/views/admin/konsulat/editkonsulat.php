<div class="main-panel">
                                    ...
                                    <form name="f1" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" readonly name="nise" value="<?= $ko->nis ?>"
                                                    class="form-control" id="nisee" placeholder="NIS">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" name="" readonly class="form-control"
                                                    value="<?= $ko->nama ?>" id="nama" placeholder="Nama" required>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" name="" readonly value="<?= $ko->alamat ?>"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <a href="#bannerformmodal" data-toggle="modal"
                                                    ...
                                                    <input type="text" name="pem" id="pem"
                                                        value="<?= $ko->pembimbing ?>" class="form-control"
                                            ...
                                            <div class="col">
                                                ...
                                                <a href="#nis" data-toggle="modal" data-target="#nis">
                                                    <input type="text" name="ket" id="ket"
                                                        value="<?= $ko->ketua_konsulat ?>" class="form-control"
                                                        placeholder="" required>
                                                </a>
    ...
    <div class="modal fade bannerformmodal" tabindex="-1" role="dialog" aria-labelledby="bannerformmodal"
        aria-hidden="true" id="bannerformmodal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">

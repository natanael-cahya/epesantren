<div class="main-panel">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <button type="button" class="btn btn-info" data-toggle="modal"
                                                            data-target="#modalsantriz<?= $ex->nis ?>">Tambah
                                                            Extra</button>
    ...
    <div class="modal fade" id="modalsantriz<?= $ex->nis ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="f1" method="post" enctype="multipart/form-data"
                        action="<?= base_url('admin/crud_extra/t_extra'); ?>">
                        <div class="row">
                            <div class="col">
                                <label for="nis">NIS</label>

                                <input type="text" name="nise" readonly value="<?= $ex->nis ?>" class="form-control"
                                    id="nisee" placeholder="NIS">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="" readonly class="form-control" value="<?= $ex->nama ?>"

                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <a class="btn btn-primary btn-xs text-white ml-1" href="<?= base_url('admin/admin/edit_extra_umum/');
                                                                                                                    echo $ex->id_detaile . '/' . $this->uri->segment(4) ?>"><i class="fa fa-edit"></i></a>


                                                            &nbsp;&nbsp;<a href="<?= base_url('admin/crud_extra/h/');
                                                                                    echo $ex->id_detaile ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>

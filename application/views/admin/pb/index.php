                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-right">
                                ...
                                <a target="_blank" href="<?= base_url('admin/laporan/export_Apel/bahasa'); ?>" class="btn btn-info btn-xs ">
                                    <i class="fa fa-download"></i>
                                    Download Data
                                </a>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pp as $l) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $l->pelanggaran ?></td>
                                                    <td style="width:12%;">
                                                        <?php echo date("d-m-Y", strtotime($l->tgl)); ?>
                                                    </td>
                                                    <td> <?= $l->waktu ?></td>
                                                    <td><?= $l->sanksi ?></td>
                                                    <td><?= $l->tingkat ?></td>
                                                    ...
                                                    <td style="width:10%;">
                                                        <div class="row">
                                                            <a class="btn btn-primary btn-xs text-white ml-1" href="<?= base_url('admin/admin/edit_pb/');
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select class="form-control" name="tingkat">
                                        ...
                                        <option <?= $k->tingkat == 'Sangat Berat' ? 'selected' : '' ?>>Sangat Berat
                                        </option>
                                    </select>
                                </div>
                            </div>

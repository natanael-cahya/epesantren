					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<h4 class="card-title">Data Kamar Uswah</h4>
					...
					<form name="f1z" method="post" action="<?= base_url('admin/crud_kamar/tb_kamar'); ?>">
						...
						<div class="row">
							...
							<div class="col">
								...
								<a href="javascript:void(0);" NAME="PENGAJAR" title="Klik Untuk Cari NAMA PENGAJAR" onClick='javascript:window.open("tkamarwanita","Ratting",

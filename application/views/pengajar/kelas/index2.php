				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							<div class="d-flex align-items-center">
							<a onclick="alert('Coming Soon');" class="btn btn-warning btn-round ml-auto">
						...
						"width=950,height=570,toolbar=1,status=1,");'>
								...
								<div class="row">
									<div class="col">
										...
										<input type="text" readonly name="" class="form-control" value="<?= $k->nama ?>" id="nama" placeholder="Nama">
									</div>
								</div>
								<br>
								<div class="row">
